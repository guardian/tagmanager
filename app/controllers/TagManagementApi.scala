...
object TagManagementApi extends Controller with PanDomainAuthActions {
  ...
  def updateTag(id: Long) = PerfAction {
    (APIAuthAction andThen UpdateTagPermissionsCheck).async { req =>
  ...
  def getSection(id: Long) = PerfAction {
    APIAuthAction {
  ...
  def createSection() = PerfAction {
    (APIAuthAction andThen CreateSectionPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def updateSection(id: Long) = PerfAction {
    (APIAuthAction andThen UpdateSectionPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def addEditionToSection(id: Long) = PerfAction {
    (APIAuthAction andThen AddEditionToSectionPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def removeEditionFromSection(id: Long, editionName: String) = PerfAction {
    (APIAuthAction andThen RemoveEditionFromSectionPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
  ...
  def createPillar() = PerfAction {
    (APIAuthAction andThen PillarPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def updatePillar(id: Long) = PerfAction {
    (APIAuthAction andThen PillarPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def deletePillar(id: Long) = PerfAction {
    (APIAuthAction andThen PillarPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
  ...
  def listReferenceTypes() = PerfAction {
    APIAuthAction {
      Ok(Json.toJson(ExternalReferencesTypeRepository.loadAllReferenceTypes))
    }
  }

  def checkPathInUse(tagType: String, slug: String, section: Option[Long], tagSubType: Option[String]) = PerfAction {
    APIAuthAction.async { req =>
  ...
  def mergeTag = PerfAction {
    (APIAuthAction andThen MergeTagPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def deleteTag(id: Long) = PerfAction {
    (APIAuthAction andThen DeleteTagPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
  ...
  def searchSponsorships = PerfAction {
    APIAuthAction { req =>
  ...
  def getSponsorship(id: Long) = PerfAction {
    APIAuthAction { req =>
      Ok(Json.toJson(SponsorshipRepository.getSponsorship(id).map(DenormalisedSponsorship(_))))
    }
  }

  def createSponsorship = PerfAction {
    (APIAuthAction andThen ManageSponsorshipsPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def updateSponsorship(id: Long) = PerfAction {
    (APIAuthAction andThen ManageSponsorshipsPermissionsCheck).async { req =>
      implicit val username = Option(req.user.email)
      req.body.asJson.map { json =>
  ...
  def clashingSponsorships(id: Option[Long], tagIds: Option[String], sectionIds: Option[String], validFrom: Option[Long],
                           validTo: Option[Long], editions: Option[String]) = PerfAction {
    APIAuthAction.async { req =>
  ...
  def deleteJob(jobId: Long) = PerfAction {
    (APIAuthAction andThen JobDeletePermissionsCheck) { req =>
      try {
  ...
  def rollbackJob(id: Long) = PerfAction {
    (APIAuthAction andThen JobRollbackPermissionsCheck) { req =>
