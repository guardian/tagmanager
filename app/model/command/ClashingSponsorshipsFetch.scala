...
class ClashingSponsorshipsFetch(id: Option[Long], tagId: Option[Long], sectionId: Option[Long], validFrom: Option[DateTime], validTo: Option[DateTime], editions: Option[List[String]]) extends Command {
