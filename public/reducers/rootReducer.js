...
import {TAG_CREATE_ERROR, TAG_CREATE_RECEIVE} from '../actions/TagActions/createTag';
...
// TAG CREATE
  ...
  case TAG_CREATE_RECEIVE:
    return Object.assign({}, state, {
      sections: action.refreshSections ? undefined : state.sections
    });
